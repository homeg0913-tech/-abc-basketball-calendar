...
const label={practice:"練習",game:"試合",camp:"合宿",trip:"遠征"};
const icon={practice:"⛹️",game:"🏀",camp:"🏕",trip:"🚌"};
const now=new Date();
